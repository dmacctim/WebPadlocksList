	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (act == null) {
			...
			try {
				...
				PadlockHelper daoForPadlocks = new PadlockHelper();
				request.setAttribute("allPadlocks", daoForPadlocks.showAllPadlocks());
				
				if (daoForPadlocks.showAllPadlocks().isEmpty()) {
